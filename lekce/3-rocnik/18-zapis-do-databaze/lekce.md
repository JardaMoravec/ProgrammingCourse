...
**Neskládejte** SQL f-řetězcem (`f"… {nazev} …"`). Hodnota z formuláře by se stala součástí příkazu. Proč je to nebezpečné, je [lekce 22](../22-bezpecnost-webu/lekce.md) — dnes stačí zvyk: **vždy `?`**.
