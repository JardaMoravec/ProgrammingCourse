...
Nová syntaxe **nepřibývá**. Odevzdání a prezentace jsou [lekce 24](../24-projekt-prezentace/lekce.md). Bonus [ORM](../../bonus/04-orm/lekce.md) do projektu nepatří — zůstáváte u `sqlite3`.
